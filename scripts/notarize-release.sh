...
ARTIFACT_VERSION=${KNOWLEDGED_MAC_ARTIFACT_VERSION:-$(release_artifact_version)}
FINAL_ZIP=${FINAL_ZIP:-"$ARTIFACT_DIR/KnowledgedMac-$ARTIFACT_VERSION.zip"}
FINAL_DMG=${FINAL_DMG:-"$ARTIFACT_DIR/KnowledgedMac-$ARTIFACT_VERSION.dmg"}
